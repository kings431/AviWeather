...
const RADAR_ENDPOINTS = {
  ...
  rain: (icao) => `https://plan.navcanada.ca/weather/api/alpha/?site=${icao}&image=RADAR/CAPPI_RAIN`,
  snow: (icao) => `https://plan.navcanada.ca/weather/api/alpha/?site=${icao}&image=RADAR/CAPPI_SNOW`,
};
